...
export default function ResourceCard({ title }: { title: string }) {
  return (
    <div
      className=" relative overflow-hidden rounded-2xl bg-linear-to-b from-white/6 to-white/2 border border-white/10 p-6 hover:border-white/20 hover:bg-white/6 transition-all duration-500 group cursor-pointer h-72"
    >
      {/* Radar background */}
